...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PA1     ------> UART4_RX
    */
    GPIO_InitStruct.Pin = USER_TX_Pin|USER_RX_Pin;
    ...
    handle_GPDMA1_Channel2.Init.Request = GPDMA1_REQUEST_UART4_TX;
  ...
  */
    ...
    PA7     ------> USART3_TX
    */
    GPIO_InitStruct.Pin = NBIOT_RX_Pin|NBIOT_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PA1     ------> UART4_RX
    */
    HAL_GPIO_DeInit(GPIOA, USER_TX_Pin|USER_RX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PA7     ------> USART3_TX
    */
    HAL_GPIO_DeInit(GPIOA, NBIOT_RX_Pin|NBIOT_TX_Pin);
